...
class CellTransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {

    // MARK: - Properties

    let durationExpanding = 0.25
    let durationClosing = 0.15
    var presenting = true
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if presenting == true {
            ...
            UIView.animate(withDuration: durationExpanding, delay:0.0, usingSpringWithDamping: 1.0, initialSpringVelocity: 0.0, //gives it some bounce to make the transition look neater than if you have defaults
            animations: {
